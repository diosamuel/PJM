...
export default function TestimonialCard({name,description,stars}){
    return (
        <div className="flex flex-col border shadow hover:shadow-xl rounded-lg p-5 w-[20em] text-center items-center">
            <img src="/assets/whatsapp.png" className="w-10 h-10 mb-3"/>
            ...
            <p>{description?description:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris euismod scelerisque enim, eget tincidunt leo scelerisque id. Nam id congue ligula"}</p>
        </div>
        )
}